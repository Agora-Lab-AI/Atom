...
class LlamaConfig(PretrainedConfig):
    ...
    def _rope_scaling_validation(self):
        ...
        if (
            rope_scaling_type == "ntk-by-parts"
            or rope_scaling_type == "yarn"
            or rope_scaling_type == "dynamic-yarn"
        ):
            ...
            if original_max_position_embeddings is None or not isinstance(
                ...
                raise ValueError(
                    "`rope_scaling.original_max_position_embeddings` must be set to an int when using ntk-by-parts, yarn, and dynamic-yarn"
                )
